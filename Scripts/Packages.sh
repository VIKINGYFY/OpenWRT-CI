...
UPDATE_PACKAGE "quickstart" "kenzok8/jell" "main" "" "quickstart luci-app-quickstart luci-app-store"
UPDATE_PACKAGE "luci-app-store" "kenzok8/jell" "main" "" "luci-app-store"
